...
const Product = () => {
  ...
  const [item, setItem] = useState({
    itemImage: 'https://theme.bitrixinfotech.com/bidzone/assets/images/auction-card-1.png',
    itemName: 'Enchanting Decorative Ensembles: Adorn Your Space with Elegance',
    startPrice: 40,
    currentBid:40,
  })
  ...
  return (
    <main className="mt-5" >
      ...
      {}
      <Drawer showDrawer={showDrawer} setShowDrawer={setShowDrawer} {...item} bidAmount={bidAmount} />
