...
const Login = () => {
  ...
  const onSubmit = async (e) => {
    ...
    setIsLoading(true)
    await dispatch(
      onUserLoginAction(newObj, navigate, notifyError, notifySuccess,setIsLoading)
    );
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  className="block ps-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6"
                />
              </div>
            </div>
